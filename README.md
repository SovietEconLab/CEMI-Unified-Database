...
- Everything in this repository — the data (the SQLite database and all Excel
  inputs) and the code (all Python scripts) — is released under the
...
> Kim, Donghyuk, Chi-Ok Hwang, Sangyun Kim, and Useong Jang.
> “SovietEconLab/CEMI-Unified-Database: CEMI Unified Database V1.0.0 – Initial
> Public Release”. Zenodo, July 8, 2026. https://doi.org/10.5281/zenodo.21254566.
