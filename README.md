...
1961–1987. It lets anyone reproduce the resource end-to-end: (A) re-run the
...
(~7.3 MB) that opens in any browser without a server. It exposes the corpus on twelve
...
Provenance, and the bilingual Glossary. A Provenance tab and per-record
“Source Material” links resolve every figure and record through sheets_index back
to its originating transcribed source workbook and sheet. This script uses only the
